...
export default function RecipeGenerator() {
  ...
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-7 min-h-screen pb-16">
        {/* Left Sidebar – visible only on md+ screens */}
        <aside className="hidden md:block md:col-span-2 border-r border-gray-200 bg-white">
          <Sidebar />
        </aside>

        {/* Main Content */}
        <main className="col-span-1 md:col-span-3 bg-gray-50">
          {/* Header */}
          ...
          <section className="p-8 max-w-3xl mx-auto space-y-8">
            ...
            {generatedRecipe && (
              <div className="group bg-white p-6 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                ...
                {isSaved && (
                  <p className="mt-4 text-green-700 text-center text-sm font-medium">
                    Recipe Saved!
                  </p>
                )}
              </div>
        ...
        <aside className="hidden md:block md:col-span-2 border-l border-gray-200 bg-white">
          <RightSidebar />
        </aside>
      </div>
