  ...
  return (
    <>
      <div className="grid grid-cols-1 md:grid-cols-7 min-h-screen pb-16">
        ...
        <aside className="hidden md:block md:col-span-2 border-r border-gray-300 bg-white">
          <Sidebar />
        </aside>
        ...
        <aside className="hidden md:block md:col-span-2 border-l border-gray-300 bg-white">
          <RightSidebar />
        </aside>
      </div>
